...
def cleaner(loan_amnt,funded_amnt,term,int_rate,installment,emp_length,home_ownership,annual_inc,
        ...
        """Takes data from the online form and converts it into the format that the machine learning 
            model was trained on as well as converts into a data frame. It also creates dummy variables for the 
            variables that have no data"""
